...
Multi linked list merupakan pengembangan linked list yang memiliki hubungan bertingkat antara data induk dan data anak. Satu node induk dapat terhubung dengan beberapa node anak dalam linked list tersendiri. Struktur ini cocok untuk menggambarkan relasi satu ke banyak, seperti kategori dengan item atau kelas dengan mahasiswa, serta memudahkan pengelolaan data yang saling berhubungan.
...
#endif
```
Program ini menggunakan Multi Linked List untuk mengelola data kategori makanan (parent) dan menu (child). Pertama, list induk diinisialisasi. Kemudian dibuat tiga data parent yaitu Makanan Berat, Minuman, dan Dessert. Setelah itu, setiap kategori diisi dengan beberapa menu sebagai data child.
...
### Output Unguided 1 :
##### Output 1
![Screenshot Output Unguided 1_1](https://github.com/wilfaiz/103112400187_Wildan-Filza-Al-Faiz/blob/main/Pertemuan13_Modul13/1.png)
![Screenshot Output Unguided 1_1](https://github.com/wilfaiz/103112400187_Wildan-Filza-Al-Faiz/blob/main/Pertemuan13_Modul13/2.png)
![Screenshot Output Unguided 1_1](https://github.com/wilfaiz/103112400187_Wildan-Filza-Al-Faiz/blob/main/Pertemuan13_Modul13/3.png)

penjelasan unguided 1 
Program ini menerapkan Multi Linked List untuk menyimpan data golongan hewan sebagai parent dan data hewan sebagai child. List parent diinisialisasi, lalu dibuat lima golongan hewan: Aves, Mamalia, Pisces, Amfibi, dan Reptil, kemudian dimasukkan ke dalam list.
