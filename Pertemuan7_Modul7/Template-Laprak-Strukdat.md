...
## Dasar Teori
Struktur data adalah metode untuk mengatur dan menyimpan data agar dapat diproses secara efisien. Salah satu struktur yang paling umum adalah stack, yaitu struktur linear dengan prinsip LIFO—elemen yang terakhir masuk akan menjadi yang pertama keluar. Stack memiliki operasi dasar seperti *push*, *pop*, *top*, *isEmpty*, dan *isFull* untuk mengelola data dari bagian atas. Struktur ini banyak digunakan dalam call stack, fitur undo/redo, evaluasi ekspresi, backtracking, hingga riwayat browser, sehingga pemahaman stack sangat penting dalam perancangan algoritma dan aplikasi.

[1].

### A. stack br/>
Stack merupakan struktur data berurutan yang hanya memungkinkan akses pada elemen paling atas dan bekerja dengan prinsip LIFO, yakni elemen terakhir yang masuk akan menjadi yang pertama keluar. Operasi utamanya meliputi push (menambah elemen ke atas), pop (menghapus elemen teratas), top/peek (melihat elemen paling atas), serta isEmpty untuk mengecek apakah stack kosong.
...
#endif
```
Program ini mengimplementasikan stack berbasis linked list dengan operasi dasar seperti push, pop, update, view, dan search. Data 1–5 dimasukkan ke stack, dua elemen teratas dihapus, beberapa data diperbarui, lalu dilakukan pencarian nilai tertentu.
...
#endif
```
Program ini menggunakan stack berbasis linked list untuk menampilkan proses pembalikan isi stack. Data dimasukkan dan dihapus dengan `push()` dan `pop()`, lalu isi stack ditampilkan sebelum dan sesudah dibalik menggunakan `balikStack()`.
...
### Output Unguided 1 :
##### Output 1
![Screenshot Output Unguided 1_1](https://github.com/wilfaiz/103112400187_Wildan-Filza-Al-Faiz/blob/main/Pertemuan7_Modul7/sssoall1.png)

penjelasan unguided 1 
Program di atas mengimplementasikan struktur data stack menggunakan linked list, di mana setiap elemen direpresentasikan sebagai node yang saling terhubung. Fungsi createStack menginisialisasi stack dengan menjadikan top bernilai Nil, sementara isEmpty digunakan untuk memeriksa apakah stack kosong. Fungsi alokasi membuat node baru yang berisi angka tertentu, dan dealokasi menghapus node dari memori. Operasi push menambahkan node baru ke bagian atas stack, sedangkan pop menghapus node teratas dan menampilkan data yang dihapus. Fungsi update memungkinkan perubahan nilai node berdasarkan posisi tertentu di dalam stack. Fungsi view menampilkan seluruh isi stack dari elemen teratas hingga terbawah, dan searchData digunakan untuk mencari nilai tertentu dalam stack serta menunjukkan posisinya. Secara keseluruhan, kode ini menyediakan operasi dasar stack dengan mekanisme LIFO menggunakan struktur linked list.
